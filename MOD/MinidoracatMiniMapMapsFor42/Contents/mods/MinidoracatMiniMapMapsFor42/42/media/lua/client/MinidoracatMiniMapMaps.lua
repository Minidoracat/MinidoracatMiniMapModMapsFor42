-- MinidoracatMiniMapMaps.lua — Minidoracat 小地圖「地圖包」（純資料註冊，
...
if MinidoracatMiniMapAPI and MinidoracatMiniMapAPI.registerMaps then
    MinidoracatMiniMapAPI.registerMaps("MinidoracatMiniMapMapsFor42", {
        { zip = "Muldraugh_FireDept.pyramid.zip", mapMod = "beek_muldraugh_firedept",
            bounds = { 10496, 8960, 11008, 9472 }, nameKey = "UI_MinidoracatMiniMapMaps_MuldraughFireDept" },
        { zip = "Estate 39.pyramid.zip", mapMod = "Estate 39",
            bounds = { 8192, 9728, 8704, 10240 }, nameKey = "UI_MinidoracatMiniMapMaps_Estate39" },
        { zip = "Chinatown Expansion B42 version.pyramid.zip", mapMod = "Chinatown Expansion B42 version",
            bounds = { 10752, 8192, 11264, 9216 }, nameKey = "UI_MinidoracatMiniMapMaps_Chinatown" },
    ...
    print("[MinidoracatMiniMapMaps] 找不到主 MOD API（MinidoracatMiniMapAPI）——請安裝並啟用 Minidoracat MiniMap for B42 主 MOD")
end
